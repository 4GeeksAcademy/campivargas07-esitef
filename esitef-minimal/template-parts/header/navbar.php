...
$mobile_prefix = '
<li class="nav-close">
  <button class="btn-nav-close" id="menu-close" aria-label="' . esc_attr__( 'Cerrar menú', 'esitef-minimal' ) . '">
        ...
        <ul id="menu-menu-principal" class="navbar-nav">
          ...
          <li class="menu-item menu-item-has-children">
            ...
            <ul class="sub-menu">
              ...
              <li><a href="<?php echo esc_url( home_url( '/nuestros-libros/' ) ); ?>"><? esc_html_e( 'Libros', 'esitef-minimal' ); ?></a></li>
              <li><a href="<?php echo esc_url( home_url( '/blog/' ) ); ?>"><? esc_html_e( 'Artículos', 'esitef-minimal' ); ?></a></li>
